...
GT1=0;GT2=0;GT3=0;GT4=0;GT5=0;GT6=0;GT7=0;GT8=0;GT9=0;GT10=0;GT11=0;GT12=0;GT13=0;GT14=0;GT15=0
TOOL="$SCRIPT_DIR/acceptance/run_with_timeout.py"

run_gate() {
    local num="$1"; local name="$2"; local cmd="$3"; local timeout="${4:-60}"
    echo ""; printf "[%d/15] %-35s " "$num" "$name"
...
run_gate 12 "API runtime"               "python3.11 $GATES_DIR/12-api-runtime.py" 120 || true
...
TOTAL=$((GT1+GT2+GT3+GT4+GT5+GT6+GT7+GT8+GT9+GT10+GT11+GT12+GT13+GT14+GT15))
